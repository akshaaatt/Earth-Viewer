    ...
    fun reloadTextures() {
        ...
        if (subFiles != null) {
            loop@ for (file in subFiles) {
                ...
                when {
                    OpenGLES20Renderer.getTag(file.name) == 'm' -> {
                    ...
                    OpenGLES20Renderer.getTag(file.name) == 'h' -> {
                    ...
                    OpenGLES20Renderer.getTag(file.name) == 'I' || OpenGLES20Renderer.getTag(
                        file.name
                    ) == 'W' -> {
                    ...
                    OpenGLES20Renderer.getTag(file.name) == 'a' || OpenGLES20Renderer.getTag(
                        file.name
                    ) == 'b' -> {
                    ...
                    OpenGLES20Renderer.getTag(file.name) == 'O' -> {
                    ...
                    OpenGLES20Renderer.getTag(file.name) == 'e' -> {
